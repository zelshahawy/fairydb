...
mod tests {
    ...
    fn test_estimated_record_count_simple() {
        ...
        let estimated_count_res =
            stat_manager.estimate_count_and_sel(2, std::slice::from_ref(&predicate));
        assert_eq!(
            estimated_count_res,
        ...
        let estimated_count_res =
            stat_manager.estimate_count_and_sel(c_id, std::slice::from_ref(&predicate));
